    ...
    value: function () {
      function equals(node) {
        ...
        return this.single('equals', function () {
          return (0, _Utils.nodeEqual)(_this6.node, node);
        });
      }
    ...
    value: function () {
      function matchesElement(node) {
        ...
        return this.single('matchesElement', function () {
          return (0, _Utils.nodeEqual)(node, _this7.node, function (a, b) {
            return a <= b;
          });
        });
      }
    ...
    value: function () {
      function parents(selector) {
        ...
        var allParents = this.wrap(this.single('parents', function (n) {
          return (0, _ShallowTraversal.parentsOfNode)(n, _this14.root.node);
        }));
