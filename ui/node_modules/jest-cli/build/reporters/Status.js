...
require('./utils');const getSummary = _require.getSummary;const trimAndFormatPath = _require.trimAndFormatPath;const wrapAnsiString = _require.wrapAnsiString;
...
class Status {
  ...
  get() {
    ...
    this._currentTests.get().forEach(record => {
      if (record) {const
        config = record.config;const testPath = record.testPath;
