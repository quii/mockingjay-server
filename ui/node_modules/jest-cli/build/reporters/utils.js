...
const formatTestPath = (config, testPath) => {var _relativePath =
  relativePath(config, testPath);const dirname = _relativePath.dirname;const basename = _relativePath.basename;
  return chalk.dim(dirname + path.sep) + chalk.bold(basename);
};
...
const wrapAnsiString = (string, terminalWidth) => {
  ...
  (lines, _ref) => {var _ref2 = _slicedToArray(_ref, 2);let kind = _ref2[0];let token = _ref2[1];
    if (kind === 'string') {
